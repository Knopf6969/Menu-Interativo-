    ...
    try:
        ...
        with open("Dados/treinos.sistema", "w", encoding="utf-8") as arquivo_de_treinos:
            for treino in treinos:
                # Garante que a ordem e as chaves estejam corretas
...
def cadastrar_treino(treinos):
    """Pede as informações ao usuário e cadastra um novo treino, usando chaves."""
...
def listar_treinos(treinos):
    """Lista todos os treinos cadastrados, com correção de sintaxe."""
